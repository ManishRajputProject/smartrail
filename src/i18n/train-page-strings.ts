...
const en: TrainStrings = {
  ...
  metaTail: "Booking window, Tatkal timing and direct alternatives.",
...
const hi: TrainStrings = {
  ...
  metaTail: "बुकिंग विंडो, तत्काल समय और अन्य सीधी ट्रेनें।",
...
const bn: TrainStrings = {
  ...
  metaTail: "বুকিং উইন্ডো, তৎকাল সময় ও অন্যান্য সরাসরি ট্রেন।",
...
const mr: TrainStrings = {
  ...
  metaTail: "बुकिंग विंडो, तत्काळ वेळ आणि इतर थेट गाड्या.",
  trainFinder: "ट्रेन फाइंडर",
...
const ta: TrainStrings = {
  ...
  metaTail: "முன்பதிவு நேரம், தத்கால் நேரம் மற்றும் பிற நேரடி ரயில்கள்.",
...
const te: TrainStrings = {
  ...
  metaTail: "బుకింగ్ విండో, తత్కాల్ సమయం మరియు ఇతర ప్రత్యక్ష రైళ్లు.",
...
const gu: TrainStrings = {
  ...
  metaTail: "બુકિંગ વિન્ડો, તત્કાલ સમય અને અન્ય સીધી ટ્રેનો.",
...
const kn: TrainStrings = {
  ...
  metaTail: "ಬುಕಿಂಗ್ ವಿಂಡೋ, ತತ್ಕಾಲ್ ಸಮಯ ಮತ್ತು ಇತರ ನೇರ ರೈಲುಗಳು.",
